...
<body class="bg-custom-bg bg-auto">
    ...
    <h1 class="text-white text-lg text-center pb-5">Add a product</h1>
    <form method="POST" action="{{route('product.store')}}">
        @csrf
        @method('POST')
        <div>
            <label class="text-white" for="name">Name</label>
            <input class="block mt-1 w-full rounded-md focus:border-slate-600 focus:ring-slate-600 border-2" type="text" name="name" id="name" placeholder="Name">
        </div>
        <div class="pt-2">
            <label class="text-white" for="description">Description</label>
            <textarea class="block mt-1 w-full rounded-md focus:border-slate-600 focus:ring-slate-600 border-2" type="text" name="description" id="description" placeholder="Description"></textarea>
        </div>
        <div class="pt-2">
        ...
        <div class="pt-2">
            ...
            <input class="block mt-1 w-full rounded-md focus:border-slate-600 focus:ring-slate-600 border-2" type="text" name="category_id" id="category_id" placeholder="Category ID">
        </div>
        <div class="pt-2">
            <label class="text-white" for="image">Image</label>
            <input class="block mt-1 w-full rounded-md focus:border-slate-600 focus:ring-slate-600 border-2" type="text" name="image" id="image" placeholder="Image description">
        </div>
        <div class="pt-2">
            <label class="text-white" for="stock">Stock</label>
            <input class="block mt-1 w-full rounded-md focus:border-slate-600 focus:ring-slate-600 border-2" type="text" name="stock" id="stock" placeholder="Stock">
        </div>
        <div class="pt-5 flex justify-between flex-col space-y-2 sm:flex-row sm:space-x-2 sm:space-y-0">
            ...
            <button class="text-white px-3 py-1 rounded-md bg-slate-500 hover:bg-slate-600 focus:outline-none focus:ring-0 focus:ring-transparent ring-offset-transparent active:bg-slate-600" type="submit">Add product</button>
        </div>
    </form>
    </div>
    </div>
