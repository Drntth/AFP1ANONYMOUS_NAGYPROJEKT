...
<body class="bg-custom-bg bg-fixed bg-cover">
    ...
    <form method="POST" action="{{route('product.store')}}"  enctype="multipart/form-data">
        ...
        <div class="pt-2">
            ...
            <input class="block mt-1 w-full rounded-md focus:border-slate-600 focus:ring-slate-600 border-2" type="text" name="description" id="description" placeholder="Description">
        </div>
        <div class="pt-2">
        ...
        <div x-data="{ open: false, selected: 'Choose an option', selectedValue: '' }" class="relative pt-2">
            ...
            <div @click="open = !open" class="appearance-none block mt-1 w-full rounded-md border-2 cursor-pointer focus:border-slate-600 focus:ring-slate-600 px-4 py-1 text-gray-700 bg-white">
