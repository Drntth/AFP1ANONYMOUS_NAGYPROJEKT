    ...
    <div class="max-w-4xl mx-auto py-6">
        ...
        @endforeach
            ...
            <div class="text-md text-gray-950 font-semibold">
                Total: <span class="">{{ array_sum(array_map(fn($item) => $item['price'], session('cart'))) }} €</span>
            </div>
            <a href="{{  route('checkout.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-800">
                Checkout
            </a>
        </div>
        @else
